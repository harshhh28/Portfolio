...
![Mobile as a server – high-level architecture](/images/blog/diagrams/mobile-as-a-server-architecture.svg)
...
![SSH access flow: PC to phone](/images/blog/diagrams/mobile-ssh-access-flow.svg)
...
![Cloudflare Tunnel: phone to internet](/images/blog/diagrams/mobile-cloudflare-tunnel.svg)
