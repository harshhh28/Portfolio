...
![Mobile as a server: high-level architecture](/assets/images/blog/diagrams/mobile-as-a-server-architecture.webp)
...
![SSH access flow: PC to phone](/assets/images/blog/diagrams/mobile-ssh-access-flow.webp)
...
![Cloudflare Tunnel: phone to internet](/assets/images/blog/diagrams/mobile-cloudflare-tunnel.webp)
...
1. [Turn Your Android Phone into a Server (Termux, Debian, Cloudflare Tunnel), on GitHub](https://github.com/Mohamadmourad/turn-phone-into-server)
